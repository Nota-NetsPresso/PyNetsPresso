...
class Compressor:
    ...
    def upload_model(
        ...
        try:
            ...
            model_info = compressor_client.upload_model(data=data, access_token=self.token_handler.tokens.access_token, verify_ssl=self.token_handler.verify_ssl)
    ...
    def get_model(self, model_id: str) -> Union[Model, CompressedModel]:
        ...
        try:
            ...
            model_info = compressor_client.get_model_info(
                model_id=model_id, access_token=self.token_handler.tokens.access_token, verify_ssl=self.token_handler.verify_ssl
            )
    ...
    def delete_model(self, model_id: str, recursive: bool = False) -> None:
        ...
        try:
            ...
            if len(children_models) != 0:
                ...
                compressor_client.delete_model(model_id=model_id, access_token=self.token_handler.tokens.access_token, verify_ssl=self.token_handler.verify_ssl)
                logger.info("Delete model successfully.")
    ...
    def __upload_dataset(self, model_id: str, dataset_path: str) -> None:
        ...
        try:
            ...
            compressor_client.upload_dataset(data=data, access_token=self.token_handler.tokens.access_token, verify_ssl=self.token_handler.verify_ssl)
    ...
    def compress_model(
        ...
        try:
            ...
            compressor_client.compress_model(data=data, access_token=self.token_handler.tokens.access_token, verify_ssl=self.token_handler.verify_ssl)
